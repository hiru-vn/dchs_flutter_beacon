...
class FBAuthorizationStatusHandler: NSObject, FlutterStreamHandler {
    ...
    func onListen(withArguments arguments: Any?, eventSink events: @escaping FlutterEventSink) -> FlutterError? {
        ...
        flutterBeaconPlugin?.flutterEventSinkAuthorization = events
        flutterBeaconPlugin?.initializeLocationManager()
        return nil
    }
    ...
    func onCancel(withArguments arguments: Any?) -> FlutterError? {
        flutterBeaconPlugin?.flutterEventSinkAuthorization = nil
        self.eventSink = nil
        return nil
    }
}
