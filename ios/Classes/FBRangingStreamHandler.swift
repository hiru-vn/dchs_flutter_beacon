...
class FBRangingStreamHandler: NSObject, FlutterStreamHandler {
    ...
    func onListen(withArguments arguments: Any?, eventSink events: @escaping FlutterEventSink) -> FlutterError? {
        ...
        flutterBeaconPlugin?.flutterEventSinkRanging = events
        flutterBeaconPlugin?.startRangingBeacon(arguments: arguments)
        return nil
    }
    ...
    func onCancel(withArguments arguments: Any?) -> FlutterError? {
        flutterBeaconPlugin?.stopRangingBeacon()
        self.eventSink = nil
        flutterBeaconPlugin?.flutterEventSinkRanging = nil
        return nil
    }
}
