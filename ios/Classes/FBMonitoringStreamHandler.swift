...
class FBMonitoringStreamHandler: NSObject, FlutterStreamHandler {
    ...
    func onListen(withArguments arguments: Any?, eventSink events: @escaping FlutterEventSink) -> FlutterError? {
        ...
        flutterBeaconPlugin?.flutterEventSinkMonitoring = events
        flutterBeaconPlugin?.startMonitoringBeacon(arguments: arguments)
        return nil
    }
    ...
    func onCancel(withArguments arguments: Any?) -> FlutterError? {
        flutterBeaconPlugin?.stopMonitoringBeacon()
        self.eventSink = nil
        flutterBeaconPlugin?.flutterEventSinkMonitoring = nil
        return nil
    }
}
